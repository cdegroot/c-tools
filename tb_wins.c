...
********************************************************/
/*
	$Id: tb_wins.c,v 1.4 1993/02/05 13:49:28 cg Rel $
*/
#include <conio.h>
#include <alloc.h>
#include <string.h>
...
#if 0
	/* Obsolete function, but we don't want to throw it away */
static void gettextv(int lx, int ly, int rx, int ry, void *dest)
{
	int i,j,w;
	int *d;
...
#define SP_FILL  ' ' + (ATT_NORM << 8)
#define BL_FILL  176 + (ATT_INVERSE << 8)
